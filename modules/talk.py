...
def cmds(event):
    ...
    бла: рандомная генерация продолжения вашего слова/предложения
    ...
    Изображения:
    бура: поиск на yande:re по тегам
...
def talk(event):
    words = ['Пошел нахуй', 'Выеби себя в жопу', 'Завали ебальник', 'На себя посмотри', 'Убейся апстену', 'Ты понимаешь,что ты бота хуесосишь?', 'Пошел нахуй, сын собаки']
    event.message_send (random.choice(words))
...
HandleCmd ('шалава', 0, talk)
HandleCmd ('дура', 0, talk)
HandleCmd ('сучка', 0, talk)
HandleCmd ('тупая', 0, talk)
HandleCmd ('ебанутая', 0, talk)
HandleCmd ('шкура', 0, talk)
HandleCmd ('пизда', 0, talk)
HandleCmd ('пизданутая', 0, talk)